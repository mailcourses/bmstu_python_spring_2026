# bmstu_python_spring_2026
Материалы курса Python в МГТУ Баумана от VK Education, весна 2026

## Лекции и материалы (слайды, домашки, код с занятий)
01. [Введение, типы данных, управляющие конструкции](lesson-01)
02. [Подробнее про основные типы данных](lesson-02)
03. [Функции](lesson-03)
04. [Классы, ООП](lesson-04)
05. [Классы, ООП, работа с файлами](lesson-05)
06. [Классы, ООП, генераторы](lesson-06)
07. [Стандартная библиотека](lesson-07)
08. [Конкурентность и параллелизм](lesson-08)
09. [Профилирование, отладка, логирование](lesson-09)
10. [Pandas, Numpy](lesson-10_11)
11. [Pandas, Numpy - 2](lesson-10_11)
12. [Алгоритмы и структуры данных](lesson-12)

## Правила оформления домашек на github
* приватный github репозиторий с каким-то связанным с курсом названием (например, bmstu_python_26a_username);
...
* Как работает мягкий дедлайн?
  > Если отправить домашку на проверку до наступления мягкого дедлайна по этой домашке, то можно получить полный балл (6). Более того, вторая и третья попытки, отправленные даже после дедлайна, уже штрафоваться не будут.
