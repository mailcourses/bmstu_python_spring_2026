# Домашнее задание #08 (конкурентность и параллелизм)
...
### 2. Для клиента и сервера опционально добавление проверочных assert

### 3. Вывод клиента и сервера для прогона ста урлов надо добавить в репу
